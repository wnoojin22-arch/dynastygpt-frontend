...
export default function ShareBanner() {
  ...
  return (
    <div className="flex px-3 sm:px-8 py-px border-b border-gold/30 bg-gold/[0.08] shadow-[0_0_20px_rgba(212,165,50,0.15),0_0_40px_rgba(212,165,50,0.08),inset_0_0_30px_rgba(212,165,50,0.06)]">
