...
const PLATFORM_STATS = [
  ...
  { label: "BEHAVIORAL DATA POINTS", value: 250000000, display: "250M+" },
];
...
export default function LeagueHome() {
  ...
  return (
    <>
      ...
      {/* ═══════════════ ③ MAIN CONTENT — league-only content (2026-07-23 revamp)
          Removed: PLATFORM UPDATE section (DraftHQAnnouncementCard),
                   BETA GUIDE card ("Welcome to DynastyGPT Beta").
          Both were platform content, not league content — migrating
          to the portfolio surface in a later pass.

          Layout: news band up top (League News + My News) →
                  League Activity → League Legends → Trade Fairness.
                  Right rail: League DynastyGPT Rankings + Trending Owners.
      */}
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 pt-4 pb-8 grid grid-cols-1 lg:grid-cols-[76fr_24fr] gap-x-6 gap-y-3 items-start">
        ...
        {/* ── NEWS RAIL — 2-col sub-grid, promoted to the top band ── */}
        <div className="order-0 lg:col-start-1 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* LEAGUE NEWS (left) */}
