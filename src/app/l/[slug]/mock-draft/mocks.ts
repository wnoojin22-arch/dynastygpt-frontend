...
export const mockOwnerProfiles: OwnerProfilesResponse & { profiles: MockOwnerProfile[] } = {
  ...
  profiles: mockOwnerOrder.map((m, i) => {
    ...
    const hitRates = [62, 58, 44, 51, 33, 56, 48, 54, 47, 40, 36, 53];
    const starRates = [22, 18, 9, 14, 6, 16, 11, 19, 12, 8, 7, 13];
    return {
      owner: m.owner,
      ...
      bust_rate: Math.max(0, 100 - hitRates[i] - 5),
      stars: Math.floor(starRates[i] * 22 / 100),
      hits: Math.floor(hitRates[i] * 22 / 100),
      busts: Math.max(0, 22 - Math.floor(hitRates[i] * 22 / 100) - Math.floor(starRates[i] * 22 / 100)),
      ...
      stars_kept: Math.floor(starRates[i] * 22 / 100 * 0.7),
      stars_flipped: Math.floor(starRates[i] * 22 / 100 * 0.3),
...
export const mockHitRates: HitRatesResponse = {
  ...
  league: {
    by_position_round: [
      { round: 1, position: "QB", total: 14, hits: 8, hit_pct: 57 },
      { round: 1, position: "RB", total: 21, hits: 11, hit_pct: 52 },
      { round: 1, position: "WR", total: 38, hits: 26, hit_pct: 68 },
      { round: 1, position: "TE", total: 8, hits: 3, hit_pct: 38 },
      { round: 2, position: "QB", total: 18, hits: 7, hit_pct: 39 },
      { round: 2, position: "RB", total: 24, hits: 9, hit_pct: 38 },
      { round: 2, position: "WR", total: 32, hits: 15, hit_pct: 47 },
      { round: 2, position: "TE", total: 10, hits: 4, hit_pct: 40 },
      { round: 3, position: "QB", total: 12, hits: 3, hit_pct: 25 },
      { round: 3, position: "RB", total: 28, hits: 7, hit_pct: 25 },
      { round: 3, position: "WR", total: 30, hits: 9, hit_pct: 30 },
      { round: 3, position: "TE", total: 14, hits: 3, hit_pct: 21 },
      { round: 4, position: "QB", total: 14, hits: 2, hit_pct: 14 },
      { round: 4, position: "RB", total: 26, hits: 4, hit_pct: 15 },
      { round: 4, position: "WR", total: 30, hits: 5, hit_pct: 17 },
      { round: 4, position: "TE", total: 12, hits: 1, hit_pct: 8 },
    ],
    overall_hit_pct: 38,
    total_evaluated: 331,
  },
  global: {
    by_position_round: [
      { round: 1, position: "QB", total: 820, hits: 394, hit_pct: 48 },
      { round: 1, position: "RB", total: 1240, hits: 595, hit_pct: 48 },
      { round: 1, position: "WR", total: 2100, hits: 1260, hit_pct: 60 },
      { round: 1, position: "TE", total: 410, hits: 135, hit_pct: 33 },
      { round: 2, position: "QB", total: 980, hits: 323, hit_pct: 33 },
      { round: 2, position: "RB", total: 1420, hits: 483, hit_pct: 34 },
      { round: 2, position: "WR", total: 1810, hits: 724, hit_pct: 40 },
      { round: 2, position: "TE", total: 520, hits: 156, hit_pct: 30 },
      { round: 3, position: "QB", total: 720, hits: 151, hit_pct: 21 },
      { round: 3, position: "RB", total: 1480, hits: 281, hit_pct: 19 },
      { round: 3, position: "WR", total: 1650, hits: 363, hit_pct: 22 },
      { round: 3, position: "TE", total: 680, hits: 109, hit_pct: 16 },
      { round: 4, position: "QB", total: 840, hits: 101, hit_pct: 12 },
      { round: 4, position: "RB", total: 1520, hits: 182, hit_pct: 12 },
      { round: 4, position: "WR", total: 1620, hits: 226, hit_pct: 14 },
      { round: 4, position: "TE", total: 620, hits: 56, hit_pct: 9 },
    ],
    overall_hit_pct: 29,
...
export const mockProspectAvailability: Record<string, AvailabilityEntry[]> = {
  "Jeremiyah Love": [{ slot: "1.12", pct_available: 0 }],
  "Fernando Mendoza": [{ slot: "1.12", pct_available: 0 }],
  "Carnell Tate": [{ slot: "1.12", pct_available: 0 }],
  "Makai Lemon": [{ slot: "1.12", pct_available: 0 }],
  "Jordyn Tyson": [{ slot: "1.12", pct_available: 0 }],
  "K.C. Concepcion": [{ slot: "1.12", pct_available: 0 }],
  "Kenyon Sadiq": [{ slot: "1.12", pct_available: 0 }],
  "Omar Cooper Jr.": [{ slot: "1.12", pct_available: 0 }],
  "Denzel Boston": [{ slot: "1.12", pct_available: 0 }],
  "Jadarian Price": [{ slot: "1.12", pct_available: 5 }],
  "Ty Simpson": [{ slot: "1.12", pct_available: 3 }, { slot: "2.03", pct_available: 0 }],
  "Eli Stowers": [{ slot: "1.12", pct_available: 96 }, { slot: "2.03", pct_available: 0 }],
  "Jonah Coleman": [{ slot: "1.12", pct_available: 96 }, { slot: "2.03", pct_available: 0 }],
  "Mike Washington Jr.": [{ slot: "1.12", pct_available: 100 }, { slot: "2.03", pct_available: 0 }],
  "Elijah Sarratt": [{ slot: "1.12", pct_available: 100 }, { slot: "2.03", pct_available: 8 }],
  "Nicholas Singleton": [{ slot: "1.12", pct_available: 100 }, { slot: "2.05", pct_available: 12 }],
  "Emmett Johnson": [{ slot: "1.12", pct_available: 100 }, { slot: "2.05", pct_available: 26 }],
  "Chris Brazzell II": [{ slot: "2.03", pct_available: 62 }, { slot: "2.05", pct_available: 38 }],
  "Garrett Nussmeier": [{ slot: "2.05", pct_available: 88 }, { slot: "3.09", pct_available: 14 }],
};
