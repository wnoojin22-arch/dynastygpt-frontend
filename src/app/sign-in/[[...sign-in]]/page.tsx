...
const clerkAppearance = {
  ...
  elements: {
    ...
    formFieldInput: {
      ...
      backgroundColor: "#0d1117", color: "#eeeef2", borderColor: "#1a1e30",
      borderRadius: "8px", padding: "12px 14px",
      transition: "border-color 0.15s ease",
    },
    formFieldInputFocused: { borderColor: GOLD, boxShadow: `0 0 0 1px ${GOLD}` },
    formFieldSuccessText: { color: "#b0b2c8" },
    otpCodeFieldInput: { backgroundColor: "#0d1117", borderColor: "#1a1e30", color: "#eeeef2", borderRadius: "8px" },
    formButtonPrimary: {
    ...
    footerActionText: { color: "#b0b2c8", fontFamily: SANS },
    ...
    dividerLine: { backgroundColor: "#1a1e30" },
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 48 }}>
          <svg width={40} height={44} viewBox="0 0 52 58" xmlns="http://www.w3.org/2000/svg" style={{ filter: "drop-shadow(0 0 12px rgba(212,168,67,0.4))" }}>
            <defs>
              ...
              <linearGradient id="siText" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor={GOLD_BRIGHT} /><stop offset="100%" stopColor="#b8860b" />
              </linearGradient>
            </defs>
            <path d="M26,2 L48,14 L48,34 Q48,50 26,56 Q4,50 4,34 L4,14 Z" fill="none" stroke="url(#siGold)" strokeWidth="2.5" />
